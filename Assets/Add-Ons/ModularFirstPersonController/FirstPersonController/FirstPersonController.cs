...
public class FirstPersonController : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        if (enableZoom)
        {
            ...
            // Changes isZoomed when key is presse
    ...
    private void Crouch()
    {
        ...
        {
            audioSource.PlayOneShot(crouchSound); // Putar audio
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.Space();
        GUILayout.Label("Modified by Wordsmith", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Bold, fontSize = 16 });
        GUILayout.Label("Modification version 1.6.9", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Normal, fontSize = 12 });
        EditorGUILayout.Space();
        ...
        fpc.audioSource = (AudioSource)EditorGUILayout.ObjectField(new GUIContent("Audio Source", "Audio source used for playing sounds."), fpc.audioSource, typeof(AudioSource), true);

        EditorGUILayout.BeginHorizontal();
        EditorGUILayout.PrefixLabel(new GUIContent("Walk Sound", "Sound played when walking."));
        fpc.walkSound = (AudioClip)EditorGUILayout.ObjectField(fpc.walkSound, typeof(AudioClip), false);
        EditorGUILayout.EndHorizontal();

        EditorGUILayout.BeginHorizontal();
        EditorGUILayout.PrefixLabel(new GUIContent("Sprint Sound", "Sound played when sprinting."));
        fpc.sprintSound = (AudioClip)EditorGUILayout.ObjectField(fpc.sprintSound, typeof(AudioClip), false);
        EditorGUILayout.EndHorizontal();

        EditorGUILayout.BeginHorizontal();
        EditorGUILayout.PrefixLabel(new GUIContent("Jump Sound", "Sound played when jumping."));
        fpc.jumpSound = (AudioClip)EditorGUILayout.ObjectField(fpc.jumpSound, typeof(AudioClip), false);
        EditorGUILayout.EndHorizontal();

        EditorGUILayout.BeginHorizontal();
        EditorGUILayout.PrefixLabel(new GUIContent("Land Sound", "Sound played when landing."));
        fpc.landSound = (AudioClip)EditorGUILayout.ObjectField(fpc.landSound, typeof(AudioClip), false);
        EditorGUILayout.EndHorizontal();

        EditorGUILayout.BeginHorizontal();
        EditorGUILayout.PrefixLabel(new GUIContent("Crouch Sound", "Sound played when crouching."));
        fpc.crouchSound = (AudioClip)EditorGUILayout.ObjectField(fpc.crouchSound, typeof(AudioClip), false);
        EditorGUILayout.EndHorizontal();
